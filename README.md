...
After launching this environment, you can test GitLab CI by launching the [inveks/gitlab-ci-vagrant](https://github.com/inveks/gitlab-ci-vagrant) enironment.
...
GitLab is also configured to use the optional `ldaps://dc.example.com` Active Directory LDAP endpoint as configured by [inveks/windows-domain-controller-vagrant](https://github.com/inveks/windows-domain-controller-vagrant).

[inveks/gitlab-source-link-proxy](https://github.com/inveks/gitlab-source-link-proxy) is installed to let you use [SourceLink](https://github.com/dotnet/sourcelink) to access the source code from within the Visual Studio debugger.
