...
gitlab-create-project-and-import https://github.com/inveks/gitlab-ci-validate-jwt.git gitlab-ci-validate-jwt $example_group_id
gitlab-create-project-and-import https://github.com/inveks/gitlab-vagrant.git gitlab-vagrant $example_group_id
gitlab-create-project-and-import https://github.com/inveks/ubuntu-vagrant.git ubuntu-vagrant $example_group_id
gitlab-create-project-and-import https://github.com/inveks/example-dotnet-source-link.git example-dotnet-source-link $example_group_id
gitlab-create-project-and-import https://github.com/inveks/MailBounceDetector.git MailBounceDetector $example_group_id
gitlab-create-project-and-import https://github.com/inveks/HelloSeleniumWebDriver.git HelloSeleniumWebDriver $example_group_id
gitlab-create-project-and-import https://github.com/inveks/hello-puppeteer-windows-container.git hello-puppeteer-windows-container $example_group_id
