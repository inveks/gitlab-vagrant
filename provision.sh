...
gitlab_version="${1:-15.1.0-ce.0}"; shift || true
...
# NB this assumes you are running https://github.com/inveks/windows-domain-controller-vagrant.
...
# see https://gitlab.com/gitlab-org/gitlab-foss/blob/v15.1.0/app/models/user.rb
# see https://gitlab.com/gitlab-org/gitlab-foss/blob/v15.1.0/app/models/personal_access_token.rb
# see https://gitlab.com/gitlab-org/gitlab-foss/blob/v15.1.0/app/controllers/profiles/personal_access_tokens_controller.rb
...
# see https://gitlab.com/gitlab-org/gitlab-foss/blob/v15.1.0/app/models/appearance.rb
gitlab-rails runner -e production - <<'EOF'
